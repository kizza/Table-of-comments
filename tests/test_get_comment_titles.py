...
# - You set the input set_text() as well as any particular settings with set_settings()
# - Finally you can run find() or text_equals() to check results which appear in the test output summary
#
